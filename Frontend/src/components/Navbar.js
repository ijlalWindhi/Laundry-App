...
import {Home, User, Users, Briefcase, Box, CreditCard, LogOut, ShoppingCart} from 'react-feather'
        ...
        <div>
          <ul>
            ...
            <li className="mt-1 ml-3 pl-6 hover:bg-red-500 hover:text-white hover:rounded-full w-9/12">
              <NavLink to="/outlet" activeClassName="active" className="flex items-center p-4 text-base font-normal md:dark:hover:text-white dark:hover:bg-green-700 dark:hover:text-white dark:border-gray-700">
                <Briefcase className="mr-3" /> 
                Outlet
              </NavLink>
            </li>
            <li className="mt-1 ml-3 pl-6 hover:bg-red-500 hover:text-white hover:rounded-full w-9/12">
              <NavLink to="/paket" activeClassName="active" className="flex items-center p-4 text-base font-normal md:dark:hover:text-white dark:hover:bg-green-700 dark:hover:text-white dark:border-gray-700">
                <Box className="mr-3" />
                Paket
              </NavLink>
            </li>
            <li className="mt-1 ml-3 pl-6 hover:bg-red-500 hover:text-white hover:rounded-full w-9/12">
              <NavLink to="/user" activeClassName="active" className="flex items-center p-4 text-base font-normal md:dark:hover:text-white dark:hover:bg-green-700 dark:hover:text-white dark:border-gray-700">
                <User className="mr-3" />
                User
              </NavLink>
            </li>
